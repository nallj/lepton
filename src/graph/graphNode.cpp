...
std::vector<std::shared_ptr<applicationTrace>> graphNode::getDependentApplicationTraces() {

  std::vector<std::shared_ptr<applicationTrace>> dependent_application_traces;
