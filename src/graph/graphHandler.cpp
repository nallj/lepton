...
std::vector<graph> graphHandler::formGraphsFromTgffFile(const std::string& input_file) {
...
void graphHandler::markGraphTasksWithIps(const std::vector<graph>& graphs, unsigned ip_count) {
...
void graphHandler::markGraphTasksWithIpsRecursive(graphNode* node, unsigned ip_count) {
